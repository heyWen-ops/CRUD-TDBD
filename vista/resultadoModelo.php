<?php
// Asegurar sesión sin errores
if (session_status() === PHP_SESSION_NONE) {
    session_start();
}

// Inicializar variable si no existe para evitar errores en count()
...
<head>
    ...
    <title>Resultados de Modelos</title>
...
<body>
    ...
    <header>
        ...
        <p>Modelos de dispositivos encontrados en el sistema.</p>
    </header>
    ...
    <main>
        <section class="tarjeta-resultado">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-group" style="display: flex; gap: 5px;">
                                            <form action="../vista/editarModelo.php" method="GET">
                                                <input type="hidden" name="id" value="<?= $fila['id_modelo']; ?>">
            ...
            <?php else: ?>
                <div class="mensaje-vacio">
                    <p>No se encontraron modelos registrados.</p>
                </div>
            <?php endif; ?>
        ...
        <script>
            function eliminarRegistro(boton) {
                ...
                fetch('../controlador/eliminarModelo.php', {
                        method: 'POST',
                        body: datos
                    })
                    .then(res => res.text())
