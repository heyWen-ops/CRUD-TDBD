...
<head>
    ...
    <title>Resultados de Descripciones</title>
...
<body>
    ...
    <header>
        ...
        <p>Descripciones registradas en el sistema.</p>
    </header>
    ...
    <tr>
        ...
        <th>Acciones</th> 
                                   ...
                                   <td><?php echo htmlspecialchars($fila['modelo']); ?></td>
                                    ...
                                    <td>
                                        <div class="button-group" style="display: flex; gap: 5px;">
                                            <form action="../vista/editarDescripcion.php" method="GET">
                                                <input type="hidden" name="id" value="<?= $fila['id_descripcion']; ?>">
            ...
            <?php else: ?>
                <div class="mensaje-vacio">
                    <p>No se encontraron descripciones registradas.</p>
                </div>
            <?php endif; ?>
        ...
        <script>
            function eliminarRegistro(boton) {
                ...
                fetch('../controlador/eliminarDescripcion.php', {
                        method: 'POST',
                        body: datos
                    })
                    .then(res => res.text())
