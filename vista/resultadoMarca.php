<?php
// Evitar el error de "sesión ya iniciada"
if (session_status() === PHP_SESSION_NONE) {
    session_start();
}

// Evitar el error si se abre la vista directamente sin pasar por el controlador
...
<head>
    ...
    <title>Resultados de Marcas</title>
    ...
    <main>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-group" style="display: flex; gap: 5px;">
                                            <form action="../vista/editarMarca.php" method="GET">
                                                <input type="hidden" name="id" value="<?= $fila['id_marca']; ?>">
        ...
        <script>
            function eliminarRegistro(boton) {
                ...
                fetch('../controlador/eliminarMarca.php', {
                        method: 'POST',
                        body: datos
                    })
                    .then(res => res.text())
